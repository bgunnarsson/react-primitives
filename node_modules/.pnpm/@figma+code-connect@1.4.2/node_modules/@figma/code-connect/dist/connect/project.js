...
exports.mapImportSpecifier = mapImportSpecifier;
    ...
    find_up_1.default.sync((currentDir) => {
        ...
        if (fs_1.default.existsSync(packageJsonPath)) {
            ...
            if (packageJsonContains(packageJson, 'angular')) {
                ...
                label = label_language_mapping_1.CodeConnectLabel.Angular;
                return find_up_1.default.stop;
            }
            else if (packageJsonContains(packageJson, 'vue')) {
                showMessage('Vue', 'vue', packageJson, currentDir);
                label = label_language_mapping_1.CodeConnectLabel.Vue;
                return find_up_1.default.stop;
            }
        }
    }, { cwd: dir });
 ...
 */
function mapImportSpecifier(specifier, config) {
