            ...
            ...new Set(imports.map((imp) => {
                if (config) {
                    ...
                    if (typeof imp.moduleSpecifier === 'string') {
                        const mappedFromSpecifier = (0, project_1.mapImportSpecifier)(imp.moduleSpecifier, config);
                        if (mappedFromSpecifier) {
                            return imp.statement.replace(/['"]([@\.\/a-zA-Z0-9_-]*)['"]/, `'${mappedFromSpecifier}'`);
                        }
                    }
