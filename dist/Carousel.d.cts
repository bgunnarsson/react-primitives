...
declare const CarouselContent: React__default.ForwardRefExoticComponent<
  CarouselContentProps & React__default.RefAttributes<HTMLDivElement>
>
interface CarouselItemProps extends React__default.HTMLAttributes<HTMLDivElement> {}
declare const CarouselItem: React__default.ForwardRefExoticComponent<
  CarouselItemProps & React__default.RefAttributes<HTMLDivElement>
>
interface CarouselPreviousProps extends React__default.ButtonHTMLAttributes<HTMLButtonElement> {}
declare const CarouselPrevious: React__default.ForwardRefExoticComponent<
  CarouselPreviousProps & React__default.RefAttributes<HTMLButtonElement>
>
interface CarouselNextProps extends React__default.ButtonHTMLAttributes<HTMLButtonElement> {}
declare const CarouselNext: React__default.ForwardRefExoticComponent<
  CarouselNextProps & React__default.RefAttributes<HTMLButtonElement>
>
