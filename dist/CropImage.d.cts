...
import { ImageFormat, ImageUrlBuilder } from './Image.cjs';
...
interface CropImageProps extends Omit<React__default.HTMLAttributes<HTMLPictureElement>, 'children'> {
    ...
    imgProps?: Omit<React__default.ImgHTMLAttributes<HTMLImageElement>, 'src' | 'srcSet' | 'alt' | 'width' | 'height' | 'className'>;
    /** Override URL builder. Default appends `width`/`height`/`format`/`quality` query params. */
    buildUrl?: ImageUrlBuilder;
}
declare const CropImage: React__default.ForwardRefExoticComponent<CropImageProps & React__default.RefAttributes<HTMLPictureElement>>;
