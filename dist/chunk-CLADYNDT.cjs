...
var RadixDialog = _interopRequireWildcard(_reactdialog)
...
var SheetOverlay = _react2.default.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ _jsxruntime.jsx.call(void 0, RadixDialog.Overlay, { ref, className, ...props })
)
SheetOverlay.displayName = 'SheetOverlay'
var SheetContent = _react2.default.forwardRef(
  ({ side = 'right', className, overlayClassName, overlayStyle, children, ...props }, ref) =>
    /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, SheetPortal, {
      children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, SheetOverlay, {
          className: overlayClassName,
          style: overlayStyle,
        }),
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, RadixDialog.Content, {
          ref,
          'data-side': side,
          className,
          ...props,
