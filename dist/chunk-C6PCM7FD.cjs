...
var DialogOverlay = _react2.default.forwardRef(
  ({ className, ...props }, ref) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, RadixDialog.Overlay, { ref, className, ...props })
);
DialogOverlay.displayName = "DialogOverlay";
var DialogContent = _react2.default.forwardRef(
  ({ className, overlayClassName, children, ...props }, ref) => /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, DialogPortal, { children: [
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, DialogOverlay, { className: overlayClassName }),
