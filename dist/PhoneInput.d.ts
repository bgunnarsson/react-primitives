...
interface PhoneInputProps
  extends Omit<React__default.InputHTMLAttributes<HTMLInputElement>, 'type' | 'value' | 'defaultValue' | 'onChange'> {
...
declare const PhoneInput: React__default.ForwardRefExoticComponent<
  PhoneInputProps & React__default.RefAttributes<HTMLInputElement>
>
