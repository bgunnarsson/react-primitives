...
var CodeBlock = ({ code, title, children, ...props }) => {
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 'div', {
    ...
    children: [
        ...
        children: [
          ...
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 'button', {
            ...
            children: copied
              ...
              : /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 'svg', {
                  xmlns: 'http://www.w3.org/2000/svg',
                  width: '16',
                  height: '16',
                  viewBox: '0 0 24 24',
      ...
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 'pre', {
        'data-slot': 'pre',
        children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 'code', {
          'data-slot': 'code',
          children: _nullishCoalesce(children, () => code),
        }),
      }),
    ],
  })
