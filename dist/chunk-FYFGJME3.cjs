"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; } function _nullishCoalesce(lhs, rhsFn) { if (lhs != null) { return lhs; } else { return rhsFn(); } } function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; }// src/components/Editable/Editable.tsx
...
var Editable = _react2.default.forwardRef(
  ({
    ...
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, EditableContext.Provider, { value: ctx, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
      "div",
      {
        ref,
...
var EditablePreview = _react2.default.forwardRef(
...
var EditableControls = ({ children }) => {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _jsxruntime.Fragment, { children: children({ editing, startEdit, submit, cancel }) });
};
...
exports.Editable = Editable; exports.EditablePreview = EditablePreview; exports.EditableInput = EditableInput; exports.EditableTextarea = EditableTextarea; exports.EditableControls = EditableControls;
