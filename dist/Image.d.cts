...
interface ImageProps
  extends Omit<React__default.ImgHTMLAttributes<HTMLImageElement>, 'src' | 'srcSet' | 'width' | 'height'> {
  src: string
  alt: string
  width: number
  height: number
...
declare const Image: React__default.ForwardRefExoticComponent<
  ImageProps & React__default.RefAttributes<HTMLImageElement>
>
