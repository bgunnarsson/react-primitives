...
var PhoneInput = _react2.default.forwardRef(
  (
    ...
    const initialCountry = _nullishCoalesce(
      _nullishCoalesce(
        findCountryFromValue(controlled ? valueProp : _nullishCoalesce(defaultValue, () => ''), countries),
    ...
    return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 'div', {
      ...
      style,
      children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 'select', {
          'aria-label': 'Country',
          value: country.code,
          ...
          children: countries.map((c) =>
            /* @__PURE__ */ _jsxruntime.jsxs.call(
              void 0,
              'option',
              { value: c.code, children: [c.flag, ' ', c.name, ' (+', c.dialCode, ')'] },
              c.code
            )
          ),
        }),
