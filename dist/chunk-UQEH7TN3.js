...
var SheetOverlay = React.forwardRef(
  ({ className, ...props }, ref) => /* @__PURE__ */ jsx(RadixDialog.Overlay, { ref, className, ...props })
);
SheetOverlay.displayName = "SheetOverlay";
var SheetContent = React.forwardRef(
  ({ side = "right", className, overlayClassName, children, ...props }, ref) => /* @__PURE__ */ jsxs(SheetPortal, { children: [
