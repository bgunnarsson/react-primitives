...
var Stepper = ({ value, orientation = "horizontal", ...props }) => /* @__PURE__ */ jsx(StepperContext.Provider, { value: { value, orientation }, children: /* @__PURE__ */ jsx("ol", { "data-orientation": orientation, "aria-label": "Progress", ...props }) });
...
var StepperItem = ({ step, ...props }) => {
  ...
  return /* @__PURE__ */ jsx(StepperItemContext.Provider, { value: { step, state }, children: /* @__PURE__ */ jsx("li", { "data-state": state, "data-step": step, ...props }) });
};
var StepperIndicator = (props) => {
  const { step, state } = React.useContext(StepperItemContext);
  return /* @__PURE__ */ jsx("span", { "data-state": state, "aria-hidden": "true", ...props, children: props.children ?? (state === "completed" ? "\u2713" : step) });
};
