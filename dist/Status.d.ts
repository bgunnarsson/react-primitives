...
declare const Status: React__default.ForwardRefExoticComponent<StatusProps & React__default.RefAttributes<HTMLSpanElement>>;
interface StatusIndicatorProps extends React__default.HTMLAttributes<HTMLSpanElement> {
}
declare const StatusIndicator: React__default.ForwardRefExoticComponent<StatusIndicatorProps & React__default.RefAttributes<HTMLSpanElement>>;
interface StatusLabelProps extends React__default.HTMLAttributes<HTMLSpanElement> {
}
declare const StatusLabel: React__default.ForwardRefExoticComponent<StatusLabelProps & React__default.RefAttributes<HTMLSpanElement>>;
