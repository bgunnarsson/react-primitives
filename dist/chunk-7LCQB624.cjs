"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; } function _nullishCoalesce(lhs, rhsFn) { if (lhs != null) { return lhs; } else { return rhsFn(); } } function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; }// src/components/TreeView/TreeView.tsx
...
var TreeView = _react2.default.forwardRef(
  ({ defaultExpanded, expanded: expandedProp, onExpandedChange, selected, onSelectedChange, children, ...props }, ref) => {
    const [uncontrolled, setUncontrolled] = _react2.default.useState(() => new Set(_nullishCoalesce(defaultExpanded, () => ( []))));
    ...
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, TreeContext.Provider, { value, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "ul", { ref, ...props, children }) });
  }
);
      ...
      /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
        "li",
        {
          ...
          children: [
            ...
            hasChildren && isExpanded ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "ul", { role: "group", children }) : null
          ]
        }
      )
    );
...
exports.TreeView = TreeView; exports.TreeItem = TreeItem;
