...
var Status = React.forwardRef(({ value, label, showLabel = false, children, ...rest }, ref) => {
...
var StatusIndicator = React.forwardRef((props, ref) =>
  /* @__PURE__ */ jsx('span', { ref, 'aria-hidden': 'true', 'data-part': 'indicator', ...props })
)
