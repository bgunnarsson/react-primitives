...
function VirtualListInner(
  { items, itemSize, children, overscan = 4, height, getItemKey, orientation = 'vertical', style, onScroll, ...rest },
  ref
) {
  ...
  for (let i = startIndex; i < endIndex; i++) {
    ...
    visible.push(
      /* @__PURE__ */ _jsxruntime.jsx.call(
        void 0,
        _react2.default.Fragment,
        { children: children({ item: items[i], index: i, style: itemStyle }) },
        getItemKey ? getItemKey(items[i], i) : i
      )
    )
  }
  const scrollerStyle = {
    ...
    position: 'relative',
    ...(horizontal
      ? { width: _nullishCoalesce(height, () => '100%') }
      : { height: _nullishCoalesce(height, () => '100%') }),
    ...style,
  }
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 'div', {
    ...
    style: scrollerStyle,
    ...rest,
    children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 'div', { style: spacerStyle, children: visible }),
  })
}
