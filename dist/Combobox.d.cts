...
declare const ComboboxTrigger: React__default.ForwardRefExoticComponent<
  RadixPopover.PopoverTriggerProps & React__default.RefAttributes<HTMLButtonElement>
>
interface ComboboxContentProps extends React__default.ComponentPropsWithoutRef<typeof PopoverContent> {}
declare const ComboboxContent: React__default.ForwardRefExoticComponent<
  ComboboxContentProps & React__default.RefAttributes<HTMLDivElement>
>
interface ComboboxInputProps extends React__default.ComponentPropsWithoutRef<typeof Command.Input> {}
declare const ComboboxInput: React__default.ForwardRefExoticComponent<
  ComboboxInputProps & React__default.RefAttributes<HTMLInputElement>
>
interface ComboboxListProps extends React__default.ComponentPropsWithoutRef<typeof Command.List> {}
declare const ComboboxList: React__default.ForwardRefExoticComponent<
  ComboboxListProps & React__default.RefAttributes<HTMLDivElement>
>
interface ComboboxItemProps extends React__default.ComponentPropsWithoutRef<typeof Command.Item> {}
declare const ComboboxItem: React__default.ForwardRefExoticComponent<
  ComboboxItemProps & React__default.RefAttributes<HTMLDivElement>
>
