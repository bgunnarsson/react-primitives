...
var TreeView = _react2.default.forwardRef(
  ({ defaultExpanded, expanded: expandedProp, onExpandedChange, selected, onSelectedChange, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, TreeContext.Provider, { value, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "ul", { ref, role: "tree", ...props, children }) });
  }
);
...
//# sourceMappingURL=chunk-2V2ZGCBF.cjs.map