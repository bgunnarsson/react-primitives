...
var SheetOverlay = React.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ jsx(RadixDialog.Overlay, { ref, className, ...props })
)
...
export { Sheet, SheetTrigger, SheetPortal, SheetClose, SheetTitle, SheetDescription, SheetOverlay, SheetContent }
