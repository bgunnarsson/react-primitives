"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; } function _nullishCoalesce(lhs, rhsFn) { if (lhs != null) { return lhs; } else { return rhsFn(); } } function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; }// src/components/PhoneInput/PhoneInput.tsx
...
var PhoneInput = _react2.default.forwardRef(
  ({
    value: valueProp,
    defaultValue,
    onValueChange,
    ...
    const initialCountry = _nullishCoalesce(_nullishCoalesce(findCountryFromValue(controlled ? valueProp : _nullishCoalesce(defaultValue, () => ( "")), countries), () => ( countries.find((c) => c.code === defaultCountry))), () => ( countries[0]));
    const initialDigits = (() => {
      const v = controlled ? valueProp : _nullishCoalesce(defaultValue, () => ( ""));
      if (!v.startsWith("+") || !initialCountry) {
        return "";
      }
      return v.slice(1 + initialCountry.dialCode.length);
    })();
    const [country, setCountry] = _react2.default.useState(initialCountry);
    const [nationalDigits, setNationalDigits] = _react2.default.useState(initialDigits);
    _react2.default.useEffect(() => {
      ...
      if (next) {
        setCountry(next);
        setNationalDigits(_optionalChain([valueProp, 'optionalAccess', _ => _.slice, 'call', _2 => _2(1 + next.dialCode.length)]));
      } else if (!valueProp) {
        setNationalDigits("");
      }
    ...
    const emit = (c, digits) => {
      _optionalChain([onValueChange, 'optionalCall', _3 => _3(buildE164(c, digits), c)]);
    };
    ...
    return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { "data-disabled": disabled || void 0, className, style, children: [
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
        "select",
        {
          ...
          children: countries.map((c) => /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "option", { value: c.code, children: [
            c.flag,
            " ",
            c.name,
            " (+",
...
exports.DEFAULT_COUNTRIES = DEFAULT_COUNTRIES; exports.PhoneInput = PhoneInput;
