...
var NumberInput = _react2.default.forwardRef(
  ({ value, onChange, min, max, step = 1, disabled, className, ...props }, ref) => {
    ...
    const increment = () =>
      _optionalChain([onChange, 'optionalCall', (_2) => _2(clamp(_nullishCoalesce(value, () => 0) + step))])
    const decrement = () =>
      _optionalChain([onChange, 'optionalCall', (_3) => _3(clamp(_nullishCoalesce(value, () => 0) - step))])
    return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 'div', {
      ...
      children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 'button', {
          type: 'button',
          onClick: decrement,
          disabled: disabled || (min !== void 0 && _nullishCoalesce(value, () => 0) <= min),
          tabIndex: -1,
          children: '\u2212',
        }),
        ...
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 'button', {
          type: 'button',
          onClick: increment,
          disabled: disabled || (max !== void 0 && _nullishCoalesce(value, () => 0) >= max),
          tabIndex: -1,
          children: '+',
        }),
      ],
