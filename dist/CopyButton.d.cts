...
interface CopyButtonProps
  extends Omit<React__default.ButtonHTMLAttributes<HTMLButtonElement>, 'children' | 'onCopy' | 'onError'> {
...
declare const CopyButton: React__default.ForwardRefExoticComponent<
  CopyButtonProps & React__default.RefAttributes<HTMLButtonElement>
>
