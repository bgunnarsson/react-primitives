...
var TimePicker = ({
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
    /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _chunkAMR32PDCcjs.Popover, { open, onOpenChange: setOpen, children: [
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkAMR32PDCcjs.PopoverTrigger, { disabled, className: triggerClassName, "aria-label": ariaLabel, children: formatDisplay(value, hour12, placeholder) }),
      /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _chunkAMR32PDCcjs.PopoverContent, { className: contentClassName, children: [
    ...
    name && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "input", { type: "hidden", name, value: value ? `${pad(current.hours)}:${pad(current.minutes)}` : "" })
  ] });
};
