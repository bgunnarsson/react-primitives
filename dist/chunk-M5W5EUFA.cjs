...
var CropImage = _react2.default.forwardRef(
  ({
    ...
    quality,
    format = "webp",
    densities = _chunkWZECPL7Ccjs.DEFAULT_DENSITIES,
    eager,
    imgClassName,
    imgProps,
    buildUrl = _chunkWZECPL7Ccjs.buildImageUrl,
    className,
    ...rest
  }, ref) => {
    ...
    const buildBase = (crop) => buildUrl(crop.src, {
      width: crop.width * baseDensity,
      height: crop.height * baseDensity,
      quality,
      format
    });
    const mobileSrcSet = _chunkWZECPL7Ccjs.buildSrcSet.call(void 0, 
      mobile.src,
      mobile.width,
      mobile.height,
      sortedDensities,
    ...
    const desktopSrcSet = desktop ? _chunkWZECPL7Ccjs.buildSrcSet.call(void 0, desktop.src, desktop.width, desktop.height, sortedDensities, quality, format, buildUrl) : null;
    ...
    return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "picture", { ref, className: cx(`${identifier}__picture`, modifier, className), ...rest, children: [
      ...
      desktop && desktopSrcSet ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
        "source",
        {
