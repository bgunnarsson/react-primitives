...
var FormField = ({ id: idProp, error, children, className, ...props }) => {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, FormFieldContext.Provider, {
    value: { id, error },
    children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 'div', { className, ...props, children }),
  })
}
var FormLabel = _react2.default.forwardRef(({ className, ...props }, ref) => {
...
var FormControl = _react2.default.forwardRef(({ ...props }, ref) => {
  const { id, error } = _react2.default.useContext(FormFieldContext)
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _reactslot.Slot, {
    ref,
    id,
...
var FormMessage = _react2.default.forwardRef(({ className, children, ...props }, ref) => {
  const { id, error } = _react2.default.useContext(FormFieldContext)
  const message = _nullishCoalesce(error, () => children)
  if (!message) return null
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 'p', {
    ref,
    id: `${id}-message`,
    role: 'alert',
    className,
