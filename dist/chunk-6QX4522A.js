...
var CropImage = React.forwardRef(
  ({
    ...
    const desktopSrcSet = desktop ? buildSrcSet(desktop.src, desktop.width, desktop.height, sortedDensities, quality, format, buildUrl) : null;
    ...
    return /* @__PURE__ */ jsxs("picture", { ref, className: cx(`${identifier}__picture`, modifier, className), ...rest, children: [
      /* @__PURE__ */ jsx(
        "source",
        {
      ...
      desktop && desktopSrcSet ? /* @__PURE__ */ jsx(
        "source",
        {
