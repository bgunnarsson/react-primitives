...
var Timeline = React.forwardRef(
  ({ orientation = "vertical", ...props }, ref) => /* @__PURE__ */ jsx(TimelineContext.Provider, { value: { orientation }, children: /* @__PURE__ */ jsx("ol", { ref, "data-orientation": orientation, ...props }) })
);
Timeline.displayName = "Timeline";
var TimelineItem = React.forwardRef(
  ({ state = "default", ...props }, ref) => {
    const { orientation } = React.useContext(TimelineContext);
    return /* @__PURE__ */ jsx(TimelineItemContext.Provider, { value: { state }, children: /* @__PURE__ */ jsx("li", { ref, "data-state": state, "data-orientation": orientation, ...props }) });
  }
);
...
var TimelineConnector = React.forwardRef((props, ref) => {
  const { orientation } = React.useContext(TimelineContext);
  const { state } = React.useContext(TimelineItemContext);
  return /* @__PURE__ */ jsx("span", { ref, "data-state": state, "data-orientation": orientation, "aria-hidden": "true", ...props });
});
TimelineConnector.displayName = "TimelineConnector";
var TimelineContent = React.forwardRef((props, ref) => /* @__PURE__ */ jsx("div", { ref, ...props }));
TimelineContent.displayName = "TimelineContent";
var TimelineTitle = React.forwardRef(
  ({ as: Tag = "p", ...props }, ref) => {
    const Component = Tag;
