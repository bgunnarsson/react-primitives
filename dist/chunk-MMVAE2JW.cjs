...
var DateRangePicker = ({
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _chunkAMR32PDCcjs.Popover, {
    open,
    onOpenChange: handleOpenChange,
    children: [
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkAMR32PDCcjs.PopoverTrigger, {
        disabled,
        className: triggerClassName,
        children: label,
      }),
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkAMR32PDCcjs.PopoverContent, {
        className: contentClassName,
        children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _reactdaypicker.DayPicker, {
          mode: 'range',
          selected: value,
          onSelect: (range) => {
            ...
            if (
              ...
              _optionalChain([range, 'optionalAccess', (_3) => _3.from]) &&
              _optionalChain([range, 'optionalAccess', (_4) => _4.to])
            ) {
              setOpen(false)
            }
          },
