...
declare const AccordionItem: React__default.ForwardRefExoticComponent<
  AccordionItemProps & React__default.RefAttributes<HTMLDivElement>
>
interface AccordionTriggerProps extends React__default.ComponentPropsWithoutRef<typeof RadixAccordion.Trigger> {}
declare const AccordionTrigger: React__default.ForwardRefExoticComponent<
  AccordionTriggerProps & React__default.RefAttributes<HTMLButtonElement>
>
interface AccordionContentProps extends React__default.ComponentPropsWithoutRef<typeof RadixAccordion.Content> {}
declare const AccordionContent: React__default.ForwardRefExoticComponent<
  AccordionContentProps & React__default.RefAttributes<HTMLDivElement>
>
