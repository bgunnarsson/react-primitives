...
var SelectTrigger = React.forwardRef(({ className, children, ...props }, ref) =>
  /* @__PURE__ */ jsxs(RadixSelect.Trigger, {
    ref,
    className,
    ...props,
    children: [children, /* @__PURE__ */ jsx(RadixSelect.Icon, {})],
  })
)
SelectTrigger.displayName = 'SelectTrigger'
var SelectContent = React.forwardRef(({ className, children, position = 'popper', ...props }, ref) =>
  /* @__PURE__ */ jsx(RadixSelect.Portal, {
    children: /* @__PURE__ */ jsx(RadixSelect.Content, {
      ref,
      position,
      className,
      ...props,
...
var SelectItem = React.forwardRef(({ className, children, ...props }, ref) =>
  /* @__PURE__ */ jsxs(RadixSelect.Item, {
    ref,
    className,
    ...props,
    children: [
...
var SelectLabel = React.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ jsx(RadixSelect.Label, { ref, className, ...props })
)
SelectLabel.displayName = 'SelectLabel'
var SelectSeparator = React.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ jsx(RadixSelect.Separator, { ref, className, ...props })
)
