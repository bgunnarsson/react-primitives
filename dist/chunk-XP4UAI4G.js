...
var TreeView = React.forwardRef(
  ({ defaultExpanded, expanded: expandedProp, onExpandedChange, selected, onSelectedChange, children, ...props }, ref) => {
    const [uncontrolled, setUncontrolled] = React.useState(() => new Set(defaultExpanded ?? []));
    ...
    return /* @__PURE__ */ jsx(TreeContext.Provider, { value, children: /* @__PURE__ */ jsx("ul", { ref, ...props, children }) });
  }
);
