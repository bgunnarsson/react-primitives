...
declare const DateRangePicker: ({ value, onValueChange, disabled, placeholder, numberOfMonths, closeOnSelect, captionLayout, startMonth, endMonth, formatRange, triggerClassName, contentClassName, calendarClassName, }: DateRangePickerProps) => react_jsx_runtime.JSX.Element;
