"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; } function _nullishCoalesce(lhs, rhsFn) { if (lhs != null) { return lhs; } else { return rhsFn(); } }// src/components/Stepper/Stepper.tsx
var _react = require('react'); var _react2 = _interopRequireDefault(_react);
var _jsxruntime = require('react/jsx-runtime');
var StepperContext = _react2.default.createContext({ value: 1, orientation: "horizontal" });
var Stepper = ({ value, orientation = "horizontal", ...props }) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, StepperContext.Provider, { value: { value, orientation }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "ol", { "data-orientation": orientation, "aria-label": "Progress", ...props }) });
...
exports.Stepper = Stepper; exports.StepperItem = StepperItem; exports.StepperIndicator = StepperIndicator; exports.StepperTitle = StepperTitle; exports.StepperDescription = StepperDescription; exports.StepperSeparator = StepperSeparator;
