...
var Breadcrumbs = (props) =>
  /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 'nav', { 'aria-label': 'breadcrumb', ...props })
...
var BreadcrumbsPage = (props) =>
  /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 'span', { 'aria-current': 'page', ...props })
var BreadcrumbsSeparator = ({ separator, children, ...props }) =>
  /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 'span', {
    'aria-hidden': 'true',
    ...props,
    children: _nullishCoalesce(
      _nullishCoalesce(children, () => separator),
      () => '\u2022'
    ),
  })
